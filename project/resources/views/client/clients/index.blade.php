...
@section('breadcrumb')
    <breadcrumb header="@lang('headings.clients.index')">
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <data-list
                    ...
                    url-create="{{ route('client.clients.create') }}"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                    <tr>
                                        @include('client.clients._partials._head')
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr v-for="(item, index) in items" :key="index">
                                        @include('client.clients._partials._body')
