...
@section('breadcrumb')
    <breadcrumb header="@lang('headings.categories.index')">
...
@section('content')
    <div class="row mt-3">
        <div class="col-md-12">
            <data-list
                    data-source="{{ route('client.pagination.categories') }}"
                    delete-message="@lang('phrases.common.delete')"
                    url-create="{{ route('client.categories.create') }}"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                    <tr>
                                        @include('client.categories._partials._head')
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr v-for="(item, index) in items" :key="index">
                                        @include('client.categories._partials._body')
